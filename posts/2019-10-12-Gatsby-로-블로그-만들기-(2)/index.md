...
path: /build-a-blog-with-gatsby-and-typescript-part-2
---
...
좌측의 Explorer 영역을 보면 `allMarkdownRemark` 라는 스키마가 추가된 것을 확인할 수 있습니다. 대충 어떤 필드가 있는지 확인한 다음, 보고싶은 항목을 체크하여 쿼리를 날려보겠습니다.
