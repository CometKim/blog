...
export type SiteFieldsEnum = 
  ...
  'siteMetadata___profileCard___name' |
  'siteMetadata___profileCard___description' |
  'siteMetadata___profileCard___github' |
  'port' |
  'host' |
  'polyfill' |
  'pathPrefix' |
...
export type SiteSiteMetadata = {
  ...
  profileCard?: Maybe<SiteSiteMetadataProfileCard>,
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  profileCard?: Maybe<SiteSiteMetadataProfileCardFilterInput>,
};

export type SiteSiteMetadataProfileCard = {
  name?: Maybe<Scalars['String']>,
  description?: Maybe<Scalars['String']>,
  github?: Maybe<Scalars['String']>,
};

export type SiteSiteMetadataProfileCardFilterInput = {
  name?: Maybe<StringQueryOperatorInput>,
  description?: Maybe<StringQueryOperatorInput>,
...
export type Unnamed_1_Query = { markdownRemark: Maybe<Pick<MarkdownRemark, 'html'>> };

export type Unnamed_2_QueryVariables = {};


export type Unnamed_2_Query = { allMarkdownRemark: { nodes: Array<(Pick<MarkdownRemark, 'excerpt' | 'id'> & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'slug' | 'date'>> })> } };

export type Unnamed_3_QueryVariables = {};


export type Unnamed_3_Query = { site: Maybe<{ siteMetadata: Maybe<{ profileCard: Maybe<Pick<SiteSiteMetadataProfileCard, 'description' | 'github' | 'name'>> }> }> };
...
export type Unnamed_4_Query = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'siteUrl'>> }> };
